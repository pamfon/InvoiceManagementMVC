...
namespace Invoice.DataAccess.Entities
{
    public class InvoiceDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new Invoice() { InvoiceId = 1, InvoiceDate = new DateTime(2024, 8, 5), PaymentTermsId = 3, CustomerId = 1 },
            new Invoice() { InvoiceId = 2, InvoiceDate = new DateTime(2024, 8, 17), PaymentTermsId = 3, CustomerId = 1 },
            new Invoice() { InvoiceId = 3, InvoiceDate = new DateTime(2024, 9, 7), PaymentTermsId = 3, CustomerId = 2 },
            new Invoice() { InvoiceId = 4, InvoiceDate = new DateTime(2024, 9, 28), PaymentTermsId = 4, CustomerId = 2 },
            new Invoice() { InvoiceId = 5, InvoiceDate = new DateTime(2024, 10, 8), PaymentTermsId = 3, CustomerId = 3 },
            new Invoice() { InvoiceId = 6, InvoiceDate = new DateTime(2024, 10, 31), PaymentTermsId = 4, CustomerId = 3 },
            new Invoice() { InvoiceId = 7, InvoiceDate = new DateTime(2024, 11, 11), PaymentTermsId = 3, CustomerId = 4 },
            new Invoice() { InvoiceId = 8, InvoiceDate = new DateTime(2024, 11, 12), PaymentTermsId = 5, CustomerId = 4 },
            new Invoice() { InvoiceId = 9, InvoiceDate = new DateTime(2024, 11, 24), PaymentTermsId = 3, CustomerId = 5 },
            new Invoice() { InvoiceId = 10, InvoiceDate = new DateTime(2024, 12, 8), PaymentTermsId = 3, CustomerId = 6 },
            new Invoice() { InvoiceId = 11, InvoiceDate = new DateTime(2024, 12, 21), PaymentTermsId = 2, CustomerId = 7 },
            new Invoice() { InvoiceId = 12, InvoiceDate = new DateTime(2024, 12, 23), PaymentTermsId = 3, CustomerId = 8 });
