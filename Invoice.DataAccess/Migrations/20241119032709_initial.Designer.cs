...
namespace InvoiceManagement.DataAccess.Migrations
{
    ...
    [Migration("20241119032709_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Invoice.DataAccess.Entities.Customer", b =>
                {
            ...
            modelBuilder.Entity("Invoice.DataAccess.Entities.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            InvoiceId = 1,
                            CustomerId = 1,
                            InvoiceDate = new DateTime(2024, 8, 5, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentTermsId = 3,
                            PaymentTotal = 0.0
                        },
                        new
                        {
                            InvoiceId = 2,
                            CustomerId = 1,
                            InvoiceDate = new DateTime(2024, 8, 17, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentTermsId = 3,
                            PaymentTotal = 0.0
                        },
                        new
                        {
                            InvoiceId = 3,
                            CustomerId = 2,
                            InvoiceDate = new DateTime(2024, 9, 7, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentTermsId = 3,
                            PaymentTotal = 0.0
                        },
                        new
                        {
                            InvoiceId = 4,
                            CustomerId = 2,
                            InvoiceDate = new DateTime(2024, 9, 28, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentTermsId = 4,
                            PaymentTotal = 0.0
                        },
                        new
                        {
                            InvoiceId = 5,
                            CustomerId = 3,
                            InvoiceDate = new DateTime(2024, 10, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentTermsId = 3,
                            PaymentTotal = 0.0
                        },
                        new
                        {
                            InvoiceId = 6,
                            CustomerId = 3,
                            InvoiceDate = new DateTime(2024, 10, 31, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentTermsId = 4,
                            PaymentTotal = 0.0
                        },
                        new
                        {
                            InvoiceId = 7,
                            CustomerId = 4,
                            InvoiceDate = new DateTime(2024, 11, 11, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentTermsId = 3,
                            PaymentTotal = 0.0
                        },
                        new
                        {
                            InvoiceId = 8,
                            CustomerId = 4,
                            InvoiceDate = new DateTime(2024, 11, 12, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentTermsId = 5,
                            PaymentTotal = 0.0
                        },
                        new
                        {
                            InvoiceId = 9,
                            CustomerId = 5,
                            InvoiceDate = new DateTime(2024, 11, 24, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentTermsId = 3,
                            PaymentTotal = 0.0
                        },
                        new
                        {
                            InvoiceId = 10,
                            CustomerId = 6,
                            InvoiceDate = new DateTime(2024, 12, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentTermsId = 3,
                            PaymentTotal = 0.0
                        },
                        new
                        {
                            InvoiceId = 11,
                            CustomerId = 7,
                            InvoiceDate = new DateTime(2024, 12, 21, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentTermsId = 2,
                            PaymentTotal = 0.0
                        },
                        new
                        {
                            InvoiceId = 12,
                            CustomerId = 8,
                            InvoiceDate = new DateTime(2024, 12, 23, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymentTermsId = 3,
                            PaymentTotal = 0.0
                        });
                });

            modelBuilder.Entity("Invoice.DataAccess.Entities.InvoiceLineItem", b =>
                {
            ...
            modelBuilder.Entity("Invoice.DataAccess.Entities.PaymentTerms", b =>
                {
                    b.Property<int>("PaymentTermsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Invoice.DataAccess.Entities.Invoice", b =>
                {
                    b.HasOne("Invoice.DataAccess.Entities.Customer", "Customer")
                        .WithMany("Invoices")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Invoice.DataAccess.Entities.PaymentTerms", "PaymentTerm")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("Invoice.DataAccess.Entities.InvoiceLineItem", b =>
                {
                    b.HasOne("Invoice.DataAccess.Entities.Customer", null)
                        .WithMany("LineItems")
                        .HasForeignKey("CustomerId");
