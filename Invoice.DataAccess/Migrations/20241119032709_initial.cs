...
namespace InvoiceManagement.DataAccess.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvoiceLineItems_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 8, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 3, 0.0 },
                    { 2, 1, new DateTime(2024, 8, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 3, 0.0 },
                    { 3, 2, new DateTime(2024, 9, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 3, 0.0 },
                    { 4, 2, new DateTime(2024, 9, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 4, 0.0 },
                    { 5, 3, new DateTime(2024, 10, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 3, 0.0 },
                    { 6, 3, new DateTime(2024, 10, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 4, 0.0 },
                    { 7, 4, new DateTime(2024, 11, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 3, 0.0 },
                    { 8, 4, new DateTime(2024, 11, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 5, 0.0 },
                    { 9, 5, new DateTime(2024, 11, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 3, 0.0 },
                    { 10, 6, new DateTime(2024, 12, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 3, 0.0 },
                    { 11, 7, new DateTime(2024, 12, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 2, 0.0 },
                    { 12, 8, new DateTime(2024, 12, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 3, 0.0 }
                });

            migrationBuilder.InsertData(
                table: "InvoiceLineItems",
                columns: new[] { "InvoiceLineItemId", "Amount", "CustomerId", "Description", "InvoiceId" },
                values: new object[,]
                {
                    { 1, 1089.99, null, "Part 123", 1 },
                    { 2, 173499.5, null, "Service XYZ", 1 },
                    { 3, 4654499.5, null, "Part 110", 2 },
                    { 4, 78799.5, null, "Part A", 2 },
                    { 5, 679.5, null, "Part AA", 3 },
                    { 6, 786.89999999999998, null, "Part Z", 3 },
                    { 7, 998.5, null, "Trip 1", 4 },
                    { 8, 1011.5, null, "Service XYZ", 4 },
                    { 9, 565735.5, null, "Rental DEF", 5 },
                    { 10, 5753.5, null, "Rental ZZZ", 5 },
                    { 11, 58453.900000000001, null, "Service ABC", 6 },
                    { 12, 111232.5, null, "Service ABC", 6 },
                    { 13, 109.5, null, "Rental ABC", 7 },
                    { 14, 57846.5, null, "Rental ABC", 8 },
                    { 15, 132.5, null, "Trip 2", 9 },
                    { 16, 6877.8999999999996, null, "Service XYZ", 9 },
                    { 17, 8999.5, null, "Trip 3", 10 },
                    { 18, 1033.5, null, "Blah blah", 10 },
                    { 19, 56455.5, null, "Ho hum", 11 },
                    { 20, 1454589.5, null, "Fiddle dee", 11 },
                    { 21, 583453.5, null, "Service ABC", 12 },
                    { 22, 567.5, null, "Fiddle dum", 12 }
                });

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceLineItems_CustomerId",
                table: "InvoiceLineItems",
                column: "CustomerId");
